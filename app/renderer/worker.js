...
const drift = __webpack_require__(73)

// In renderer process (web page).
const ipcRenderer = __webpack_require__(55).ipcRenderer
...
// Node.js).
var Lazy = __webpack_require__(43);

// Check if ES6 features are supported and, if so, include ES6-specific Lazy.js
// features.
var isHarmonySupported = __webpack_require__(78).isHarmonySupported;
...
const lazy = __webpack_require__(54)
const execFileSync = __webpack_require__(80).execFileSync;
...
(function(context) {
  ...
  if (typeof Lazy === 'undefined' && "function" === 'function') {
    Lazy = __webpack_require__(43);
  }
